        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            ...
            >
              ...
              <span className="text-xl font-bold text-neutral-900">Klynaa</span>
            </Link>
          </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              {!isAuthPage && (
                <div className="flex items-center space-x-4">
                  <Link
                    href="/auth/login"
                    className="text-neutral-700 hover:text-emerald-600 px-3 py-2 text-sm font-medium transition-colors"
                  >
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-neutral-200">
            ...
            <div className="px-3 py-2 border-b border-neutral-200 mb-4">
              <LanguageSwitcher variant="light" />
            </div>
