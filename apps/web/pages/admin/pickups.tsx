    ...
    <div className="flex h-screen bg-klynaa-lightgray dark:bg-neutral-900 overflow-hidden">
      ...
      <div className="w-64 text-white flex flex-col shadow-xl border-r border-neutral-600" style={{ backgroundColor: '#2E7D32' }}>
        ...
        <nav className="flex-1 p-4 space-y-2">
          ...
          <Link href="/admin/pickups" className="flex items-center p-3 rounded-lg font-medium transition-colors bg-white" style={{ color: '#4CAF50' }}>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="p-6 flex-1 bg-klynaa-lightgray dark:bg-neutral-900 overflow-y-auto">
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-gray-600">Monitor pickup routes, assign workers, and manage collection schedules.</p>

            <div className="mt-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4 border rounded-lg">
                  <h4 className="font-medium text-lg" style={{ color: '#4CAF50' }}>Active Pickups</h4>
                  <p className="text-2xl font-bold">82</p>
                </div>
                <div className="p-4 border rounded-lg">
                  <h4 className="font-medium text-lg" style={{ color: '#4CAF50' }}>Completed Today</h4>
                  <p className="text-2xl font-bold">156</p>
                </div>
                <div className="p-4 border rounded-lg">
                  <h4 className="font-medium text-lg" style={{ color: '#4CAF50' }}>Workers Available</h4>
